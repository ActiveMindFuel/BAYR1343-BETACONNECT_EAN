 ...
 * @doc - http://docs.labs.agnitio.com/api/variable-placement
 * @version - 1.0.0
 */
 document.addEventListener('presentationInit', function() {
  ...
  app.variablePlacement = (function () {
    ...
    var items;
    var moveTheMenu; // Used if forced
    ...
    function init(rules, moveMenu) {
      items = rules || [];
      moveTheMenu = moveMenu;
      // Default lookup of mainmenu
      if (arguments.length < 2) moveTheMenu = true;
      ...
      if (window.ag) {
        ...
        if (isntAgnitio) {
          ...
          document.addEventListener('contentLoad', run)
          //run();
        }
      }
      else {
